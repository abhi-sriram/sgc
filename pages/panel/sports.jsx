...
function Index() {
  return (
    <div>
      <HeadComponent title={'Sports Panel'} />
      <div className=" flex h-screen w-full items-center justify-center rounded-sm bg-gradient-to-br from-blue-400 to-purple-500 py-10 px-5 sm:h-96  ">
